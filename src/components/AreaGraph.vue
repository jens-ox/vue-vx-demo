...
<script>
import { AreaClosed, LineShape, Bar } from '@vue-vx/shape'
import { appleStock } from '@vue-vx/mock-data'
import { curveMonotoneX } from '@vue-vx/curve'
import { LinearGradient } from '@vue-vx/gradient'
import { GridRows, GridColumns } from '@vue-vx/grid'
import { scaleTime, scaleLinear } from '@vue-vx/scale'
import { withTooltip, Tooltip } from '@vue-vx/tooltip'
import { localPoint } from '@vue-vx/event'
